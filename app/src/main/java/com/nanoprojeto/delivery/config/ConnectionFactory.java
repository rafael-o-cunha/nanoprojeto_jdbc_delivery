...
public class ConnectionFactory {
    ...
    public static Connection createNewConnection(EnvFile ev) {
        return createConnection(ev);
    }

    private static Connection createConnection(EnvFile ev) {
        try {
            String host;
            String port;
            String database;
            ...
            if (ev.equals(EnvFile.PROPERTIES)) {
                ...
                throw new IllegalArgumentException("Fonte de configuração inválida: " + ev);
            }
